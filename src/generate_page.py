...
def generate_pages_recursive(dir_path_content: str, template_path: str, dest_dir_path: str, base_path: str) -> None:
    for entry in os.listdir(dir_path_content):
            ...
            if os.path.isfile(new_dir_path_content) and new_dir_path_content.endswith("md"):
                generate_page(new_dir_path_content, template_path, new_dest_dir_path.replace(".md", ".html"), base_path)
                
            elif os.path.isdir(new_dir_path_content):
                os.makedirs(new_dest_dir_path, exist_ok=True)
                generate_pages_recursive(new_dir_path_content, template_path, new_dest_dir_path, base_path) 
